...
func (a *AppService) BuyTwo(ctx context.Context, req *v1.BuyRequest) (*v1.BuyReply, error) {
	...
	return a.uuc.BuyTwo(ctx, req, user)
}

var lockBuyThree sync.Mutex
...
var lockSetInfo sync.Mutex

// SetInfo setInfo.
func (a *AppService) SetInfo(ctx context.Context, req *v1.SetInfoRequest) (*v1.SetInfoReply, error) {
	// 在上下文 context 中取出 claims 对象
	var (
		err           error
		userId        int64
	...
	return a.uuc.SetInfo(ctx, req, &biz.User{
		ID:       userId,
		Password: tokenPassword,
	})
}
