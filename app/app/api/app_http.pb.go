...
const OperationAppSetAddress = "/api.App/SetAddress"
const OperationAppSetBalanceReward = "/api.App/SetBalanceReward"
const OperationAppSetInfo = "/api.App/SetInfo"
...
func _App_SetAddress0_HTTP_Handler(srv AppHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in SetAddressRequest
		if err := ctx.Bind(&in.SendBody); err != nil {
			return err
		}
		if err := ctx.BindQuery(&in); err != nil {
		...
		http.SetOperation(ctx, OperationAppSetAddress)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.SetAddress(ctx, req.(*SetAddressRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
		}
		reply := out.(*SetAddressReply)
		return ctx.Result(200, reply)
	}
}

func _App_DeleteAddress0_HTTP_Handler(srv AppHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, OperationAppDeleteAddress)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _App_SetInfo0_HTTP_Handler(srv AppHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in SetInfoRequest
		if err := ctx.Bind(&in.SendBody); err != nil {
			return err
		}
		if err := ctx.BindQuery(&in); err != nil {
		...
		http.SetOperation(ctx, OperationAppSetInfo)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.SetInfo(ctx, req.(*SetInfoRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
		}
		reply := out.(*SetInfoReply)
		return ctx.Result(200, reply)
	}
}
...
func _App_OrderTwoList0_HTTP_Handler(srv AppHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in OrderTwoListRequest
		if err := ctx.BindQuery(&in); err != nil {
			return err
		}
		http.SetOperation(ctx, OperationAppOrderTwoList)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.OrderTwoList(ctx, req.(*OrderTwoListRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
		}
		reply := out.(*OrderTwoListReply)
		return ctx.Result(200, reply)
	}
}

func _App_OrderThreeList0_HTTP_Handler(srv AppHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in OrderTwoListRequest
		if err := ctx.BindQuery(&in); err != nil {
			return err
		}
		http.SetOperation(ctx, OperationAppOrderThreeList)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.OrderThreeList(ctx, req.(*OrderTwoListRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
...
func _App_UnStake0_HTTP_Handler(srv AppHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in UnStakeRequest
		if err := ctx.Bind(&in.SendBody); err != nil {
			return err
		}
		if err := ctx.BindQuery(&in); err != nil {
		...
		http.SetOperation(ctx, OperationAppUnStake)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.UnStake(ctx, req.(*UnStakeRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
		}
		reply := out.(*UnStakeReply)
		return ctx.Result(200, reply)
	}
}
...
type AppHTTPClient interface {
	...
	SetAddress(ctx context.Context, req *SetAddressRequest, opts ...http.CallOption) (rsp *SetAddressReply, err error)
	...
	SetInfo(ctx context.Context, req *SetInfoRequest, opts ...http.CallOption) (rsp *SetInfoReply, err error)
...
func (c *AppHTTPClientImpl) DeleteAddress(ctx context.Context, in *DeleteAddressRequest, opts ...http.CallOption) (*DeleteAddressReply, error) {
	var out DeleteAddressReply
	pattern := "/api/app_server/delete_address"
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation(OperationAppDeleteAddress))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "POST", path, in.SendBody, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *AppHTTPClientImpl) OrderThreeList(ctx context.Context, in *OrderTwoListRequest, opts ...http.CallOption) (*OrderTwoListReply, error) {
	var out OrderTwoListReply
	pattern := "/api/app_server/order_three_list"
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, http.Operation(OperationAppOrderThreeList))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *AppHTTPClientImpl) OrderTwoList(ctx context.Context, in *OrderTwoListRequest, opts ...http.CallOption) (*OrderTwoListReply, error) {
	var out OrderTwoListReply
	pattern := "/api/app_server/order_two_list"
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, http.Operation(OperationAppOrderTwoList))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *AppHTTPClientImpl) SetAddress(ctx context.Context, in *SetAddressRequest, opts ...http.CallOption) (*SetAddressReply, error) {
	var out SetAddressReply
	pattern := "/api/app_server/set_address"
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation(OperationAppSetAddress))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "POST", path, in.SendBody, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *AppHTTPClientImpl) SetInfo(ctx context.Context, in *SetInfoRequest, opts ...http.CallOption) (*SetInfoReply, error) {
	var out SetInfoReply
	pattern := "/api/app_server/set_info"
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation(OperationAppSetInfo))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "POST", path, in.SendBody, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *AppHTTPClientImpl) UnStake(ctx context.Context, in *UnStakeRequest, opts ...http.CallOption) (*UnStakeReply, error) {
	var out UnStakeReply
	pattern := "/api/app_server/un_stake"
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation(OperationAppUnStake))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "POST", path, in.SendBody, &out, opts...)
	if err != nil {
		return nil, err
